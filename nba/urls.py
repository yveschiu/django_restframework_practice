...
# from nba.quickstart import views
...
urlpatterns += [
    ...
    path('ajax_jquery/', views.ajax_jquery, name='ajax-jquery'),
    path('ajax_jquery_POST/', views.ajax_jquery_POST,
        name='ajax-jquery-POST'),
    path('ajax_jquery_sample/', views.ajax_jquery_sample,
